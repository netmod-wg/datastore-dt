...
"datastore" leaf that can indicate a desired NMDA datastore.  If an
operation is not supported on a particular datastore then an error is
returned, as specified in "ietf-netconf-datastores" (see ^yangmod^).
