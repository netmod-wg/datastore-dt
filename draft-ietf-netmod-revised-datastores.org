...
the format in ^RFC3688^, the following registration is requested:
   ...
   URI: urn:ietf:params:xml:ns:yang:ietf-yang-architecture
...
* Ephemeral Control-Plane Datastore Example
...
* Implications onto Other Drafts
