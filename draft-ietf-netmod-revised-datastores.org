...
- conventional datastore: One of the following set of datastores:
  <running>, <startup>, <candidate>, and <intended>.  These datastores
  share a common schema and NETCONF/RESTCONF operations allow copying
  data between these datastores.  The term "conventional" is chosen
  as a generic umbrella term for these datastores.
- conventional configuration data: Configuration data that is stored
  in any of the conventional datastores.
