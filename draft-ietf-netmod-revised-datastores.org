...
- configuration datastore: A datastore holding configuration.  A
  configuration datastore maps to an instantiated YANG data tree
  consisting of configuration nodes.
