...
The model foresees dynamic datastores that are by definition not
...
ephemeral, i.e., lost upon reboot.  The dynamic datastores
...
documents maps to a dynamic datastore in the datastore
