...
accessible tree for some XPath context (see ^xpath^) and the
invocation context of operations (see ^invocation^).
...
stored in another datastore.  Section 4.4 of ^RFC6244^ then
...
** Invocation of Actions and RPCs @invocation@
...
!! include-figure ietf-datastores.yang extract-to="ietf-datastores@2018-01-11.yang"

!! include-figure ietf-origin.yang extract-to="ietf-origin@2018-01-11.yang"
